...
module.exports.onChat = async ({ api, event, message }) => {
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("@Heli Lumo") || body.startsWith("babu") || body.startsWith("janu")) {
            ...
            const randomReplies = ["এত ডাকাডাকি করিস কেন?
Rasel Boss–এর সাথে রিলেশনে থাকা মেয়েটা কিন্তু একটু স্পেশালই হবে 😉 💙", "Yes 😀, I am here", "What's up?", "Bolo jaan ki korte pari tumar jonno",  "হাসো তো প্লিজ 🌸, রাসেল মাহমুদ চাইছে তোমার মুখে আবার সেই সুন্দর হাসিটা দেখতে 🙂💙",
